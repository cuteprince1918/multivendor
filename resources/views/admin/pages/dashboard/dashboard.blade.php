                            ...
                            <table class="table table-bordered table-lg table-v2 table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <img alt="" src="{{ url('public/admin/img/flags-icons/us.png') }}" width="25px">
                                        </td>
                                        <td class="text-right">
                                            $245
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img alt="" src="{{ url('public/admin/img/flags-icons/fr.png') }}" width="25px">
                                        </td>
                                        <td class="text-right">
                                            $154
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img alt="" src="{{ url('public/admin/img/flags-icons/ca.png') }}" width="25px">
                                        </td>
                                        <td class="text-right">
                                            $112
                                        </td>
                    ...
                    <div class="user-w with-status status-green">
                        <div class="user-avatar-w">
                            <div class="user-avatar">
                                <img alt="" src="{{ url('public/admin/img/avatar1.jpg') }}">
                            </div>
                        </div>
                        <div class="user-name">
                            <h6 class="user-title">
        ...
        <div class="element-wrapper">
            ...
            <div class="element-box-tp">
                ...
                <div class="profile-tile">
                    <a class="profile-tile-box" href="users_profile_small.html">
                        <div class="pt-avatar-w">
                            <img alt="" src="{{ url('public/admin/img/avatar3.jpg') }}">
                        </div>
                        <div class="pt-user-name">
                            Ben Gossman
                        </div>
            ...
            <div class="element-box-tp">
                <div class="activity-boxes-w">
                    ...
                    <div class="activity-box-w">
                        ...
                        <div class="activity-box">
                            <div class="activity-avatar">
                                <img alt="" src="{{ url('public/admin/img/avatar2.jpg') }}">
                            </div>
                            <div class="activity-info">
                                <div class="activity-role">
                                    Ben Gossman
                    ...
                    <div class="activity-box-w">
                        ...
                        <div class="activity-box">
                            <div class="activity-avatar">
                                <img alt="" src="{{ url('public/admin/img/avatar4.jpg') }}">
                            </div>
                            <div class="activity-info">
                                <div class="activity-role">
                                    Jenny Miksa
