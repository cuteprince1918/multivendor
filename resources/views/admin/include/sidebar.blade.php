...
<div class="menu-mobile menu-activated-on-click color-scheme-dark">
    <div class="mm-logo-buttons-w">
        <a class="mm-logo" href="index.html"><img src="{{ url('public/admin/img/logo.png') }}"><span>Clean Admin</span></a>
        ...
        <div class="logged-user-i">
            ...
            <div class="logged-user-menu color-style-bright">
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{ route('admin-logout') }}"><i class="os-icon os-icon-signs-11"></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </div>
